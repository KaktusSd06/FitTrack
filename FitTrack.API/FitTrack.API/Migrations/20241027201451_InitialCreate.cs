        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Trainer_GymId = table.Column<int>(type: "integer", nullable: true),
                    Height = table.Column<int>(type: "integer", nullable: true),
                    DateOfBirth = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    TrainerId = table.Column<string>(type: "text", nullable: true),
                    User_GymId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IndividualTrainings_AspNetUsers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupTrainings_AspNetUsers_TrainerId",
                        column: x => x.TrainerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_Trainer_GymId",
                table: "AspNetUsers",
                column: "Trainer_GymId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_User_GymId",
                table: "AspNetUsers",
                column: "User_GymId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Gyms_Trainer_GymId",
                table: "AspNetUsers",
                column: "Trainer_GymId",
                principalTable: "Gyms",
                principalColumn: "Id");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_AspNetUsers_Gyms_User_GymId",
                table: "AspNetUsers",
                column: "User_GymId",
                principalTable: "Gyms",
                principalColumn: "Id");
